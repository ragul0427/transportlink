  ...
  return (
    <div className="md:w-[14vw] md:h-screen  !z-50 bg-[--secondary-color] ">
      <div className="md:w-[14vw] md:h-screen  lg:border-r lg:border-slate-200 fixed bg-[--primary-color]">
        <div className="text-center !z-50 flex text-xl border-b border-gray-100 font-bold items-center  justify-between  text-[--primary-color]   !bg-[--secondary-color] h-[9vh]   w-screen py-3">
          ...
          <div className="text-[11px] lg:text-xl">
